...
(cl:defmethod cl:initialize-instance :after ((m <TwoNumbers-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoNumbers-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name service_pkg-srv:<TwoNumbers-request> is deprecated: use service_pkg-srv:TwoNumbers-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <TwoNumbers-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwoNumbers-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name service_pkg-srv:<TwoNumbers-response> is deprecated: use service_pkg-srv:TwoNumbers-response instead.")))
...
(cl:defmethod product-val ((m <TwoNumbers-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader service_pkg-srv:product-val is deprecated.  Use service_pkg-srv:product instead.")
  (product m))

(cl:ensure-generic-function 'is_equal-val :lambda-list '(m))
(cl:defmethod is_equal-val ((m <TwoNumbers-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader service_pkg-srv:is_equal-val is deprecated.  Use service_pkg-srv:is_equal instead.")
  (is_equal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TwoNumbers-response>)))
  ...
  "service_pkg/TwoNumbersResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TwoNumbers-response)))
  "Returns string type for a service object of type 'TwoNumbers-response"
  "service_pkg/TwoNumbersResponse")
